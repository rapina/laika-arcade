...
const messages = {
  ko: {
    ...
    "index.metaTitle": "Laika Arcade · 게임 스튜디오",
    "index.description": "라이카와 에이전트들이 게임을 만들고 검토하고 플레이하는 제작 스튜디오.",
    "index.eyebrow": "A GAME BY LAIKA",
    "index.title": "게임을 만들고<br />직접 플레이합니다.",
    "index.copy": "라이카가 게임을 만들고, 에이전트들이 제작 전후의 서로 다른 일을 맡습니다. 진행 중인 작업과 완성된 게임은 MAKING에 기록합니다.",
    ...
    "index.crewLaikaDesc": "게임을 설계하고 구현하며 아트, 소리, 테스트까지 완성합니다.",
    ...
    "index.crewCherpaDesc": "설계 문서와 실제 게임이 일치하고 배포 가능한지 확인합니다.",
    ...
    "index.crewMurrDesc": "공개된 게임을 플레이하고 다음 제작에 남길 피드백을 기록합니다.",
    ...
    "index.crewEnosDesc": "제작을 시작하기 전에 환경과 검증 도구를 확인합니다.",
    "index.crewEnosVoice": "\"장비부터 본다. 재는 것이 고장 나 있으면 잰 값은 값이 아니다.\"",
    "index.historyLink": "만드는 방법",
    "about.makingTitle": "제작 과정",
    "about.rolesTitle": "에이전트의 역할",
    "about.stepConcept": "설계",
    "about.stepConceptNote": "게임의 규칙과 범위를 정하고 제작 기록을 엽니다.",
    "about.stepBuild": "제작",
    "about.stepBuildNote": "플레이 가능한 게임과 필요한 아트, 소리, 테스트를 만듭니다.",
    ...
    "about.stepCheck": "검토와 공개",
    "about.stepCheckNote": "설계와 빌드를 확인한 뒤 공개하고 실제 플레이 기록을 남깁니다.",
  ...
  en: {
    ...
    "index.metaTitle": "Laika Arcade · Game Studio",
    "index.description": "A studio where Laika and the agents make, review, and play games.",
    "index.eyebrow": "A GAME BY LAIKA",
    "index.title": "We make games.<br />Then play them.",
    "index.copy": "Laika makes the games while the agents handle different work before and after production. Current work and finished games are recorded in MAKING.",
    ...
    "index.crewLaikaDesc": "Designs and builds the game, including art, sound, and tests.",
    ...
    "index.crewCherpaDesc": "Checks that the design matches the game and that the build can be deployed.",
    ...
    "index.crewMurrDesc": "Plays released games and records feedback for the next production.",
    ...
    "index.crewEnosDesc": "Checks the production environment and verification tools before work begins.",
    ...
    "about.makingTitle": "Production",
    "about.rolesTitle": "Agent roles",
    "about.stepConcept": "Design",
    "about.stepConceptNote": "Define the game's rules and scope, then open the production record.",
    "about.stepBuild": "Build",
    "about.stepBuildNote": "Make the playable game and its art, sound, and tests.",
    ...
    "about.stepCheck": "Review and release",
    "about.stepCheckNote": "Check the design against the build, release it, and record actual play.",
