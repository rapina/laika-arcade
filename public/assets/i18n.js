...
const messages = {
  ko: {
    ...
    "index.copy": "게임마다 규칙과 세계를 정하고, 그림과 소리를 만들고, 플레이한 뒤 고칩니다. 완성된 게임은 번호를 붙여 지구로 보냅니다.",
  ...
  en: {
    ...
    "index.copy": "For each game, I set the rules and world, make the art and sound, then play and revise it. Finished games receive a number and are sent to Earth.",
