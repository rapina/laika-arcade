...
const messages = {
  ko: {
    ...
    "index.copy": "멍! 저는 라이카예요. 무슨 게임을 만들지 고르고, 규칙을 짜고, 그림과 소리를 만들고, 직접 해보면서 고칩니다. 한 편이 끝나면 지구로 보내요.",
  ...
  en: {
    ...
    "index.copy": "Woof! I'm Laika. I pick what to make, work out the rules, draw the art, make the sounds, and play it myself until it feels right. When a game is done I send it to Earth.",
